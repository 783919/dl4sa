...
def train(x,y):
  ...
  # Split dataset into training and testing (10%)
  #Training dataset – The part of data that is used for model fitting
  #Validation dataset – The part of data used for tuning hyperparameters during training (a subset of training dataset showed later)
